...
export class NegativePatternMatcher {
  private static readonly NON_OTP_PATTERNS: readonly RegExp[] = [
    /email|mail/i, /search/i, /address|street|city|state|country|zip|postal/i,
    /name|first|last|full|middle/i, /card|cvv|ccv|cvc|expir|credit|debit/i,
    /promo|coupon|discount|gift|voucher|referral/i, /comment|message|note|description|bio/i,
    /url|website|link|domain/i, /company|organization|org/i, /quantity|amount|price|total|subtotal/i,
    /date|month|year|day/i, /ssn|social|tax|national/i, /routing|account.*number|iban|swift|bic/i,
  ];
