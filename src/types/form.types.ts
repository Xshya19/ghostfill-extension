...
export const FIELD_HEURISTICS: Record<FieldType, FieldHeuristics> = {
  ...
  'last-name': {
    ...
    patterns: [
      ...
      /^sname$/i,
      /nachname/i,
      /familienname/i, // German
      /apellido/i,
      /segundo.?nombre/i, // Spanish
      /nom.?de.?famille/i, // French
      /cognome/i, // Italian
      /sobrenome/i,
      /apelido/i, // Portuguese
      /фамилия/i, // Russian
  ...
  'middle-name': {
    ...
    patterns: [
      ...
      /additional.?name/i,
      /segundo.?nombre/i,
      /nombre.?medio/i, // Spanish
      /deuxième.?prénom/i,
      /second.?prénom/i, // French
      /zweiter.?vorname/i,
      /mittelname/i, // German
      /patronym/i,
      /отчество/i, // Russian patronymic
      /middle.?initial/i,
    ],
    keywords: [
      'mname',
...
export const FORM_INDICATORS: Record<
  FormType,
  { patterns: RegExp[]; requiredFields: FieldType[] }
> = {
  login: {
