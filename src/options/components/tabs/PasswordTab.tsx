...
interface PasswordTabProps {
    ...
    onPasswordDefaultChange: <K extends keyof UserSettings['passwordDefaults']>(
        key: K,
            ...
            <SettingsSection id="password-defaults" title="Password Defaults" icon="🔐">
                <div className="setting-item">
                    ...
                    <input
                        ...
                        aria-describedby={fieldHasError('passwordDefaults.length') ? 'password-length-error' : 'password-length-desc'}
                    />
