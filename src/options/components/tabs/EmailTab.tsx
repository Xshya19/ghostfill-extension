            ...
            <SettingsSection id="email-service" title="Email Service" icon="📧">
                <div className="setting-item">
                    ...
                    <select
                        ...
                        onChange={(e) => onSettingChange('preferredEmailService', e.target.value as UserSettings['preferredEmailService'])}
                    >
                    ...
                    <div className="custom-domain-container" role="group" aria-label="Custom domain settings">
                        ...
                        <div className="setting-item vertical-group">
                            ...
                            <input
                                ...
                                aria-describedby={fieldHasError('customDomainUrl') ? 'custom-domain-url-error' : undefined}
                            />
            ...
            <SettingsSection id="inbox-polling" title="Inbox Polling" icon="📥">
                ...
                <div className="setting-item">
                    ...
                    <input
                        ...
                        aria-describedby={fieldHasError('checkIntervalSeconds') ? 'check-interval-error' : 'check-interval-desc'}
                    />
