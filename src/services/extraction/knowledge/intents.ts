...
export const CONTEXT_KEYWORD_DATABASE: Record<string, ContextKeyword[]> = {
  ...
  activation: [
    ...
    { keyword: 'confirm your account', weight: 34, strength: 'strong', category: 'activation' },
    { keyword: 'accept invitation', weight: 34, strength: 'strong', category: 'activation' },
    { keyword: 'accept invite', weight: 34, strength: 'strong', category: 'activation' },
    { keyword: 'join workspace', weight: 30, strength: 'strong', category: 'activation' },
    { keyword: 'magic link', weight: 32, strength: 'strong', category: 'activation' },
    { keyword: 'passwordless', weight: 30, strength: 'strong', category: 'activation' },
    { keyword: 'sign in securely', weight: 28, strength: 'strong', category: 'activation' },
    { keyword: 'authorize this device', weight: 28, strength: 'strong', category: 'activation' },
    { keyword: 'approve sign in', weight: 28, strength: 'strong', category: 'activation' },
  ],
