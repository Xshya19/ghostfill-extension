...
exports.FIELD_CLASSES =
  exports.NUM_STRUCTURAL_FEATURES =
  exports.NUM_TEXT_CHANNELS =
  exports.MAX_TEXT_LEN =
  exports.CHAR_VOCAB_SIZE =
    void 0;
...
function detectSplitOTP(el) {
  ...
  const sameMaxLen = containerInputs.filter((inp) => {
    ...
    return (
      (ml === 1 || ml === 2) && (inp.offsetWidth || inp.offsetHeight || inp.getClientRects().length)
    );
  });
